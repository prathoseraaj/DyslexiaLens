    ...
    <div className="w-full h-[100vh] m-0 p-0">
      ...
      <div className="h-[93h]"> 
        <div className="flex items-center m-10 mt-20 flex-col gap-1">
          <h1 className="font-bold text-4xl font-serif"> DyslexiaLens - Text Simplifier </h1>
          <p className="text-[12px] ">Paste or types your text below to simplify it for easier reading.</p>
